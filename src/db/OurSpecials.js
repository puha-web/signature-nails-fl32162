...
const ourSpecials = [
  {
    ...
    description:"Full Set / Fill In Pink / Fill In Pink & White LCN Gel Nail is the most popular, most advance type of gel nail made with high quality soft resin that provides a super glossy finish."
  },
  { 
    service: "LCN's Signature Hand Treatment",
    group: "manicure",
    img: 'https://s3.amazonaws.com/lcn-nail-spa-nc27613/images/ourSpecials/special2.png',
    description: 'Refreshing Hand Treatment service followed by collagen mask aging property that absorb into the skin, help the skin nourish and be smooth.  (Collagent Vitamin E)'
  },
  { 
